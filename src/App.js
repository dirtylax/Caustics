...
export default function App() {
  ...
  return (
    <Canvas
      ...
      <PerspectiveCamera position={[6, 0.9, 6]} far={1000} near={0.1} fov={26} />
...
function Scene(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh castShadow geometry={nodes.straw001_1.geometry} material={materials.straw_2} />
      <mesh castShadow geometry={nodes.straw001_2.geometry} material={materials.straw_1} />
      <Center rotation={[0, -0.4, 0]} position={[-1, 0, -2]} top>
